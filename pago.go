...
var ServerList = map[string]string{
	ServerProduction: "https://api.pago.sh",
	ServerSandbox:    "https://sandbox-api.pago.sh",
}
...
type SDKOption func(*Pago)

// WithServerURL allows providing an alternative server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *Pago) {
...
func New(opts ...SDKOption) *Pago {
	sdk := &Pago{
		SDKVersion: "1.0.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.0.0 2.879.6 0.1.0 github.com/pago-sh/pago-go",
