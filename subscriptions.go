...
func newSubscriptions(rootSDK *Pago, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Subscriptions {
...
func (s *Subscriptions) Create(ctx context.Context, request operations.SubscriptionsCreateSubscriptionCreate, opts ...operations.Option) (*operations.SubscriptionsCreateResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Subscriptions) Revoke(ctx context.Context, id string, opts ...operations.Option) (*operations.SubscriptionsRevokeResponse, error) {
	...
	res := &operations.SubscriptionsRevokeResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
