...
| `ScopeOrganizationAccessTokensRead`  | organization_access_tokens:read      |
| `ScopeOrganizationAccessTokensWrite` | organization_access_tokens:write     |