...
value := components.CustomerBenefitGrantSortPropertyGrantedAt
```
...
| `CustomerBenefitGrantSortPropertyProductBenefit`      | product_benefit                                       |
| `CustomerBenefitGrantSortPropertyMinusProductBenefit` | -product_benefit                                      |