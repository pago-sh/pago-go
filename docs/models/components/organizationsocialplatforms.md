...
| Name                                   | Value                                  |
| -------------------------------------- | -------------------------------------- |
| `OrganizationSocialPlatformsX`         | x                                      |
| `OrganizationSocialPlatformsGithub`    | github                                 |
| `OrganizationSocialPlatformsFacebook`  | facebook                               |
| `OrganizationSocialPlatformsInstagram` | instagram                              |
