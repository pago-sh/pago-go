...
value := components.OrderSortPropertyCreatedAt
```
...
| `OrderSortPropertyStatus`             | status                                |
| `OrderSortPropertyMinusStatus`        | -status                               |
| `OrderSortPropertyInvoiceNumber`      | invoice_number                        |
| `OrderSortPropertyMinusInvoiceNumber` | -invoice_number                       |
