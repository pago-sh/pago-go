...
import(
	...
	"github.com/pago-sh/pago-go/types"
...
func main() {
    ...
    res, err := s.Metrics.Get(ctx, operations.MetricsGetRequest{
        ...
        OrganizationID: pagogo.Pointer(operations.CreateMetricsGetQueryParamOrganizationIDFilterStr(
...
func main() {
    ...
    res, err := s.Metrics.ListDashboards(ctx, pagogo.Pointer(operations.CreateMetricsListDashboardsQueryParamOrganizationIDFilterStr(
        "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    )))
    if err != nil {
        log.Fatal(err)
