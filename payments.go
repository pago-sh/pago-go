...
func newPayments(rootSDK *Pago, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Payments {
	return &Payments{
		rootSDK:          rootSDK,
...
func (s *Payments) List(ctx context.Context, request operations.PaymentsListRequest, opts ...operations.Option) (*operations.PaymentsListResponse, error) {
	...
	res := &operations.PaymentsListResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.PaymentsListResponse, error) {
...
func (s *Payments) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.PaymentsGetResponse, error) {
	request := operations.PaymentsGetRequest{
		ID: id,
	}
