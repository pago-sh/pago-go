...
func newDownloadables(rootSDK *Pago, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Downloadables {
...
func (s *Downloadables) List(ctx context.Context, security operations.CustomerPortalDownloadablesListSecurity, benefitID *operations.CustomerPortalDownloadablesListQueryParamBenefitIDFilter, page *int64, limit *int64, opts ...operations.Option) (*operations.CustomerPortalDownloadablesListResponse, error) {
	...
	res := &operations.CustomerPortalDownloadablesListResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.CustomerPortalDownloadablesListResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListResourceDownloadableRead
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListResourceDownloadableRead = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
