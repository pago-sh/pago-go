...
type SubscriptionSeatsUpdatedEvent struct {
	...
	//lint:ignore U1000 accessed via reflection for JSON marshaling
	name     string                           `const:"subscription.seats_updated" json:"name"`
...
func (s *SubscriptionSeatsUpdatedEvent) GetID() string {
	if s == nil {
		return ""
	}
	return s.ID
...
func (s *SubscriptionSeatsUpdatedEvent) GetName() string {
	return "subscription.seats_updated"
}

func (s *SubscriptionSeatsUpdatedEvent) GetMetadata() SubscriptionSeatsUpdatedMetadata {
	if s == nil {
		return SubscriptionSeatsUpdatedMetadata{}
	}
	return s.Metadata
}
