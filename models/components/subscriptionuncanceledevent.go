...
type SubscriptionUncanceledEvent struct {
	...
	//lint:ignore U1000 accessed via reflection for JSON marshaling
	name     string                         `const:"subscription.uncanceled" json:"name"`
...
func (s *SubscriptionUncanceledEvent) GetID() string {
	if s == nil {
		return ""
	}
	return s.ID
...
func (s *SubscriptionUncanceledEvent) GetMetadata() SubscriptionUncanceledMetadata {
	if s == nil {
		return SubscriptionUncanceledMetadata{}
	}
	return s.Metadata
}
