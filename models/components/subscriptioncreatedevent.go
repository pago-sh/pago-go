...
type SubscriptionCreatedEvent struct {
	...
	//lint:ignore U1000 accessed via reflection for JSON marshaling
	name     string                      `const:"subscription.created" json:"name"`
...
func (s *SubscriptionCreatedEvent) GetMetadata() SubscriptionCreatedMetadata {
	if s == nil {
		return SubscriptionCreatedMetadata{}
	}
	return s.Metadata
}
