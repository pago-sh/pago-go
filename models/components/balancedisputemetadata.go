...
func (b *BalanceDisputeMetadata) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &b, "", false, []string{"transaction_id", "dispute_id", "amount", "currency", "presentment_amount", "presentment_currency", "tax_amount", "fee"}); err != nil {
		return err
	}
	return nil
}
