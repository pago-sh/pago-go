...
func CreateCustomFieldUpdateNumberMetadataNumber(number float64) CustomFieldUpdateNumberMetadata {
	typ := CustomFieldUpdateNumberMetadataTypeNumber
...
func (u *CustomFieldUpdateNumberMetadata) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &number, "", true, nil); err == nil {
		u.Number = &number
		u.Type = CustomFieldUpdateNumberMetadataTypeNumber
		return nil
	}
...
func (c *CustomFieldUpdateNumber) GetMetadata() map[string]CustomFieldUpdateNumberMetadata {
	if c == nil {
		return nil
	}
	return c.Metadata
...
func (c *CustomFieldUpdateNumber) GetProperties() *CustomFieldNumberProperties {
	if c == nil {
		return nil
	}
	return c.Properties
