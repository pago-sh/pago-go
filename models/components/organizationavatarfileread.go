...
func (o *OrganizationAvatarFileRead) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &o, "", false, []string{"id", "organization_id", "name", "path", "mime_type", "size", "service", "is_uploaded", "created_at", "size_readable", "public_url"}); err != nil {
		return err
	}
	return nil
}
